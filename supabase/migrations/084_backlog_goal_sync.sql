-- Sync goal_id between daily items and master backlog
...
BEFORE INSERT OR UPDATE OF text, completed, completed_at, date, backlog_task_id, is_important, is_urgent, goal_id
...
BEFORE INSERT OR UPDATE OF title, is_done, completed_at, date, backlog_task_id, is_important, is_urgent, goal_id
